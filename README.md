...
Run: npm install && vercel link && vercel env pull

Then add these keys to .env.local (append after the VERCEL_OIDC_TOKEN line):
...
Verify the agent is running by checking the deploy output for "Snapshot created"
